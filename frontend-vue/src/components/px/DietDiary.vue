<template>
  <div class="px-diary-gird" >
    ...
    <div class="px-diary-info">
        ...
        <button @click="testClick2" >test2</button>
        <input type="file" id='myfile' multiple="multiple" >
        <img :src="state.testBase" id="my-image" alt="ttt">
...
export default {
  ...
  setup () {
    ...
    function testClick2 () {
      ...
      const dataURL = file.toDataURL()
      console.log('toBase64(file).data', toBase64(file))
      console.log('dataURL', dataURL)

      axios({
        url: 'http://localhost:8001/base64file/' + toBase64(file),
        method: 'get',
    ...
    return { attributes, state, RegistDiet, testClick, testClick2 }
  }
}
</script>
